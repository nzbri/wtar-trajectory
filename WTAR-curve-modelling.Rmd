...
fig_1_width = 17;   fig_1_height = 20
...
dat = dat %>% 
  select(subject_id_num, np_group, group,	sex, symptom_onset_age,	diagnosis_age,
         education, age, age_std, group, cognitive_status, 
