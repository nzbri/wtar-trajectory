...
Alzheimer's disease were scores significantly lower than in matched controls.[@psychologicalcorporation2001_WTARWechslerTest; @strauss2006_CompendiumNeuropsychologicalTests]
...
deterioration that often occurs in Parkinson's. The Parkinson's sample comprised
only 10 participants: given the marked heterogeneity of function in this 
disorder, that greatly limits the validity of generalising from those findings.
...
establishing cognitive decline at an individual level in Parkinson's.
