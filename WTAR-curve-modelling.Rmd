...
`r n_wtar$max_sessions`, mean = `r n_wtar$mean_sessions`, total number of 
measures = `r n_wtar$total_sessions`). The period between successive WTAR
assessments was multi-modal, mostly clustering around intervals of one and two
years, due to varying follow-up periods over the course of the study (see 
Supplmentary Material). Both Parkinson's participants and Controls were 
classified as having normal cognition, mild cognitive impairment, or dementia on
the basis of a comprehensive Level II neuropsychological 
