...
keywords: Parkinson disease, cognitive impairment, dementia, neuropsychology, 
  premorbid function
wordcount: 'Abstract: 199 (of 250), main body: 2472 (of 3700)'
editor_options: 
...
used the `tidyverse` constellation of packages [@wickham2019_WelcomeTidyverse] 
...
1.96 times the standard error given by `hlme` to the MLE.
...
of stable scores despite substantial cognitive decline, provide support for the 
