...
abstract: Background. The Wechsler Test of Adult Reading (WTAR) has been
  ...
  who progressed to dementia. In both groups and regardless of current cognitive
  status, scores were higher than expected from population norms. Conclusion. 
  The WTAR was stable in Parkinson's even when participants declined from normal 
...
distribution is skewed well above the population norm mean of 100. 
...
was regardless of their latent class (blue and brown connecting lines). In each
...
baseline, rather than trajectories that meaningfully differed longitudinally. 
Those with very high initial WTAR scores maintained near-ceiling performance 
levels, even if they subsequently developed dementia (Figure
...
however: if the disease process reduced current performance on that measure, 
...
IQ scores increase substantially over time (by up to 1 standard deviation per
...
above-average estimated IQ levels. Another possibility is that by volunteering
for research, our sample may inherently be non-representative of the population
at large. Such a self-selection effect should, however, (i) apply more to the 
controls than to the Parkinson's group, which did not seem to be the case, and
(ii) affect most other research projects as well. The other neuropsychological 
test scores _did_ decrease below population norms with cognitive decline. If the
WTAR was used as an individualised premorbid reference for those scores, rather 
than a z-score norm of zero, we would expect to see inflated rates of MCI and 
PDD. This does indeed seem to occur[@marras2013_MeasuringMildCognitive] (see 
discussion below).
