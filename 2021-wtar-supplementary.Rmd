...
In Figure \@ref(fig:figure-1-histogram) in the accompanying manuscript, we show the distribution of the WTAR-estimated IQ scores in each group for the cognitive status at each observation.

## 5. Is the software mentioned?

See the Method section in the accompanying manuscript.
