...
## 10. Are the model comparison (and selection) tools described from a 
...
## 12. Are the number of cases per class reported for each model (absolute 
...
## 14a. Is a plot included with the estimated mean trajectories of the final 
solution?
...
## 14c. Is a plot included of the combination of estimated means of the final 
model and the observed individual trajectories split out for each latent class?

This is shown in Figure \@ref(fig:figure-2-trajectories) of the accompanying 
manuscript.

## 15.Are characteristics of the final class solution numerically described 
(i.e., means, SD/SE, n, CI, etc.)?
